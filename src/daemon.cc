...
//    wait for new file ...
//    new file here?
//        wait for file queue lock
//        push to queue
//        unlock queue
//        post semaphor which signals something is in queue
//    goto wait for new file
//}
//FileWorker{
//    wait for queue semaphor
//    wait for file queue lock
//    pop from queue
//    unlock queue
//    do stuff with file
...
//      ParseTaskFile_(watch_folder_ + "/" + file_name);
  ss << "Running job: " << watch_folder_ << " " << output_folder_ << " " << processing_folder_ << " " << file_name;
